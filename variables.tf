...
variable "crossplane_user_values_override" {
  type        = string
  default     = ""
  description = "User provided values to override the Crossplane helm chart defaults and those generated by Terraform using the templates."
}
...
variable "registry_display_name" {
  type        = string
  description = "Name of OCI Registry repository"
  default     = "crossplane"
}

variable "ocir_username" {
  type = string
  description = "Username for OCIR. If you are using identity providers for your user it should look like this: tenanacy_namespace/idenetity_provider_name/user_mail"  
  default = ""
}

variable "ocir_auth_token" {
  type = string
  description = "Auth token to login into OCIR. Make sure to create it before running the automation from User -> Auth Token -> Generate Auth Token"
  default = ""
}

variable "private_key_content" {
  type = string
  description = "To get the content in the correct way you need to run the command from readme file and paste the value in the variable. User private key, that is used by crossplane provider to login in cloud"
}

######aici am pus variabila


#provider
# variable "user_ocid" {
#   description = "User OCID, that is used for crossplane provider to login in cloud"
#   type = string
# }
variable "fingerprint" {
  description = "Key fingerprint, that is used for crossplane provider to login in cloud"
  type = string
}
